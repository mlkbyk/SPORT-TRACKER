...
class VideoPlayerApp(App):
    def build(self):
        ...
        self.video_path = "med_pro_sport_videos/hareket3.mp4"
    ...
    def stop_video(self, dt):
        ...
        # "body_estimation1.py" dosyasını başlat
        os.system("python body_estimation3.py")  # Alternatif olarak, subprocess kullanılabilir.
